      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        {socialProof.customerLogos?.length > 0 && (
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <h4 className="text-sm font-medium text-gray-700">Customer Logos</h4>
            </div>
        ...
        {socialProof.metricsClaimed?.length > 0 && (
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <h4 className="text-sm font-medium text-gray-700">Metrics Claimed</h4>
            </div>
            <ul className="space-y-2">
              {socialProof.metricsClaimed.map((metric, i) => (
                <li key={i} className="text-sm text-gray-700 font-medium bg-purple-50 px-3 py-2 rounded-lg">
                  {metric}
                </li>
              ))}
            </ul>
        ...
        {socialProof.caseStudies?.length > 0 && (
          <div className="md:col-span-2">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h4 className="text-sm font-medium text-gray-700">Case Studies</h4>
            </div>
        ...
        {socialProof.awards?.length > 0 && (
          <div>
            <div className="flex items-center gap-2 mb-3">
              <Award className="w-4 h-4 text-amber-600" />
              <h4 className="text-sm font-medium text-gray-700">Awards</h4>
            </div>
            <ul className="space-y-1">
